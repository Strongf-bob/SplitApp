...
| Друзья | `GET /api/friends`, accept/reject/delete; `POST /api/friend-invites`, preview/accept invite | [friends](https://github.com/Strongf-bob/SplitAppBackend/blob/main/openapi.yaml) | [FriendshipEndpoints](https://github.com/Strongf-bob/SplitApp/blob/main/SplitApp/Data/Network/Endpoints/FriendshipEndpoints.swift), [FriendInviteEndpoints](https://github.com/Strongf-bob/SplitApp/blob/main/SplitApp/Data/Network/Endpoints/FriendInviteEndpoints.swift) |
